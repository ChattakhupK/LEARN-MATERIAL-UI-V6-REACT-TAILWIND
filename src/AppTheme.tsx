          ...
          variants: [
            {
              ...
              style: {
                ...
                ...theme.applyStyles("dark", {
                  ...
                  backgroundImage: `linear-gradient(to bottom, ${theme.vars.palette.primary.main}, ${theme.vars.palette.primary.dark})`,
                }),
              },
            },
            {
        ...
        icon: (
          <Box
            sx={(theme) => ({
              ...
              boxShadow: `inset 0px 0px 0px 1px ${theme.vars.palette.grey[300]}`,
              ".MuiCheckbox-root:hover &, .MuiFormControlLabel-root:hover &": {
                boxShadow: `inset 0px 0px 0px 1px ${theme.vars.palette.grey[400]}`,
              },
              ...theme.applyStyles("dark", {
                boxShadow: `inset 0px 0px 0px 1px ${theme.vars.palette.grey[700]}`,
                ".MuiCheckbox-root:hover &, .MuiFormControlLabel-root:hover &":
                  {
                    boxShadow: `inset 0px 0px 0px 1px ${theme.vars.palette.grey[600]}`,
                  },
              }),
            })}
          />
